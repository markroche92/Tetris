...
class DisplayArea:
	...
	def createTetrisPlayArea(self):
		...
		levelLabel.place(relx=0.5, rely=0.5, relwidth=1, relheight=1,
		                 anchor=CENTER)
		...
		self.restartButton.place(relx=0.5, rely=0.375, relwidth=1,
		...
		self.startButton.place(relx=0.5, rely=1-0.125, relwidth=1,
		                       relheight=self.labelFrameHeightLen/totH,
							   anchor=CENTER)
